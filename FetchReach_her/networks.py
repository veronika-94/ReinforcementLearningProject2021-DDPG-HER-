...
class CriticNetwork(keras.Model):
    def __init__(self, fc1_dims=512, fc2_dims=512,
            name='critic', chkpt_dir='/Users/admin/Documents/codes_python/rl_exam/FetchReach/models'): #mkdir temp
...
class ActorNetwork(keras.Model):
    def __init__(self, n_actions, fc1_dims=512, fc2_dims=512, name='actor',
            chkpt_dir='/Users/admin/Documents/codes_python/rl_exam/FetchReach/models'):
